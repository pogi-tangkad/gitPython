...
# 1) set users variable to be an empty list
...
# 4) Reverse the list of ['kevin, 'alice'] to ['alice', 'kevin']
...
# 7) Slice the users lists to return the 3rd and 4th items and assign the results to 'center_users'

center_users = users[2:4]

assert center_users == ['alice', 'andy'], f"Expected 'center_users' to be ['alice', 'andy'] but got: {repr(center_users)}"
